...
import {
  Copy, Check, BarChart2, Clock, Tag, Hash, AlignLeft, List,
  TrendingUp, Lightbulb, RefreshCw, PlusCircle, FileText, Award
} from "lucide-react";
...
/* ── result panel ────────────────────────────────────────────── */
export default function SeoResultPanel({ seo, onNew, onRegenerate, loading, hideNewButton = false }) {
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                <h4 className="text-xs font-bold uppercase tracking-wider text-muted flex items-center gap-2">
                  <Lightbulb className="w-3.5 h-3.5 text-gold" /> AI Recommendations
                </h4>
