            ...
            {isActive ? (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted mt-1">
                      {isElite 
                        ? 'You have full access to A/B testing with 3 simultaneous AI generation variations.'
                        : 'You have access to 21 AI thumbnail generations per week.'}
                    </p>
                  </div>
                ...
                <div className="pt-4 border-t border-border flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
                  <span className="text-sm text-muted">Weekly limit usage: {user.proCreditsUsed || 0} / 21</span>
                  ...
                  <div className="flex gap-4 items-center w-full md:w-auto">
                    ...
                    <button className="text-sm text-gold hover:underline font-medium">Manage Billing</button>
                  </div>
                </div>
              </div>
            ) : (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted mt-1">You are currently on the free tier.</p>
                  </div>
                </div>
