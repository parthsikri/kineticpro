  ...
  try {
    ...
    if (!isSecondPass) {
      ...
      systemPrompt = [
        ...
        "",
        "YOUR TASK: Analyse the topic + creator answers and produce a complete thumbnail plan. You own every creative decision.",
        "",
    ...
    if (!isSecondPass && plan.needsMoreInfo === false) {
      const pass2System = [
        ...
        "You have deep knowledge of what makes students STOP SCROLLING and click — urgency, bold Hinglish, high-emotion faces, dramatic overlays.",
        "",
        "YOUR TASK: Analyse the topic and produce a complete thumbnail plan. You own every creative decision.",
        "",
        "Use your own judgment to decide which overlay elements genuinely fit the content.",
        "Think: what would a smart, experienced creator actually put on this thumbnail?",
        "A revision/lecture video needs a punchy headline — not an alert card or date callout.",
