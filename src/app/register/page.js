    ...
    <div className="flex-1 flex flex-col items-center justify-center min-h-screen bg-black px-4 relative">
      <div className="w-full max-w-md p-6 sm:p-8 rounded-2xl bg-charcoal border border-border space-y-6 shadow-2xl relative z-10">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-xl font-semibold text-off-white">Create your account</h2>
          <p className="text-xs text-muted">Get started with 1 free thumbnail credit</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] text-muted font-bold uppercase tracking-wider block">Confirm Password</label>
            <div className="relative">
              <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-muted" />
              <input
                type="password"
